...
import { exchangeToken, fetchKakaoUser } from "@/lib/kakao-auth";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const userId = namespacedUserId("kakao", account.userId);
    ...
    return NextResponse.redirect(`${base}/?login_error=kakao`);
  }
}
